...
>(
  (
    ...
    // Detect RTL from document direction and update on changes
    ...
    // Auto-adjust side based on RTL
    const effectiveSide = isRTL ? "right" : side;
    ...
    return (
      <main
        ...
        className={cn(
          ...
          "md:peer-data-[state=collapsed]:peer-data-[variant=inset]:peer-data-[side=left]:ml-2",
          "md:peer-data-[state=collapsed]:peer-data-[variant=inset]:peer-data-[side=right]:mr-2",
          className,
        )}
        {...props}
      />
